...
async function main() {
  ...
  const libraryPath = [
    ...
    '/srv/emase/lead-proto-service/.chrome-libs/root/lib/x86_64-linux-gnu',
  ...
  for (const width of widths) {
    ...
    const metrics = await page.evaluate(() => {
      ...
      const visibleText = Array.from(document.querySelectorAll('main h1, main h2, main h3, main p, main a, main span'))
      ...
      return {
        ...
        brokenImages,
        overflowOffenders,
        visibleWordCount: visibleText ? visibleText.split(' ').length : 0,
      };
    });
